...
<section id="ladder" style=" background-color: #FE5858">
    ...
    <h2 class="text-uppercase text-center text-white mb-0" style="padding-top: 3%;"><br><strong>ERROR</strong><br><br></h2>
    <div class="container" style=" min-height:auto;!important;">
        <div class="container text-uppercase text-center text-white " style="padding-top: 25%; padding-bottom: 35%">you shall not pass</div>
    </div>
</section>
